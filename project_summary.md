...
*   **Enhanced Home Page Hero:** Features a dynamic orbital pulsing hero logo (`_OrbitalHeroLogo`) with rotating orbit ring, ambient spark aura, glowing header badge, and a refined glassmorphic tutorial guide card while preserving the 3 color theme presets.
